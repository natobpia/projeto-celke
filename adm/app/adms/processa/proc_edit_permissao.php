...
if ($SendEditPer) {
    ...
    //Retirar os campos da validação vazio
    ...
    //Houve erro em algum campo se´ra redirecionado para o login, não há erro no formulário tenta cadastrar no banco.
    if ($erro) {
        $url_destino = pg . '/editar/edit_permissao?id=' . $dados['id'];
        header("Location: $url_destino");
    } else {
        //Alterar o menu
        $result_nivpg_up = "UPDATE adms_nivacs_pgs SET adms_menu_id='" . $dados_validos['adms_menu_id'] . "',
        modified=NOW()
