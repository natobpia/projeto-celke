                ...
                <form method="POST" action="<?php echo pg; ?>/processa/proc_cad_usuario">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-5">
                            ...
                            <input name="usuario" type="text" class="form-control" id="usuario" placeholder="Nome de usuário para login" value="<?php
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input name="senha" type="password" class="form-control" id="senha" placeholder="A senha deve ter 6 caractéres" value="<?php
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input name="apelido" type="text" class="form-control" id="apelido" placeholder="Apelido do usuário" value="<?php
