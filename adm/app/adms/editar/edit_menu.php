...
if (!empty($id)) {
    $result_men = "SELECT * FROM adms_menus WHERE id='$id' LIMIT 1";
    $resultado_men = mysqli_query($conn, $result_men);
    //Verificar se encontrou a página no banco de dados
    if (($resultado_men) and ($resultado_men->num_rows != 0)) {
        $row_edit_men = mysqli_fetch_assoc($resultado_men);
                ...
                <div class="content p-1">
                    <div class="list-group-item">
                        ...
                        <form method="POST" action="<?php echo pg; ?>/processa/proc_edit_menu">
                            <input type="hidden" name="id" value="<?php if (isset($row_edit_men['id'])) {
                                                                        echo $row_edit_men['id'];
                                                                    } ?>">

                            <div class="form-group">
                                <label>
                                    <span tabindex="0" data-placement="top" data-toggle="tooltip" title="Nome do item do menu a ser apresentado no menu">
                            ...
                            <div class="form-group">
                                <label>
                                    <span tabindex="0" data-placement="top" data-toggle="tooltip" data-html="true" title="Página de ícone: <a href='https://fontawesome.com/icons?id=gallery' target='_blank'>fontawesome</a>. Somente inserir o nome, Ex: fas fa-volume-up">
                                        <i class="fas fa-question-circle"></i>
                                    </span>
                                    <span class="text-danger">*</span> Ícone</label>
